...
from kipf.layers import Dense, GraphConvolution
from kipf.metrics import masked_softmax_cross_entropy, masked_accuracy
...
class MLP(Model):
    def __init__(self, placeholders, input_dim, learning_rate=0.01, weight_decay=5e-4, hidden1=16, **kwargs):
